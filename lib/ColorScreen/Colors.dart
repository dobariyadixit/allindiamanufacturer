...
class AppColors {
  static const Color primaryColor = Color.fromARGB(255, 255, 255, 245);
  static const Color secondaryColor = Color.fromARGB(255, 246, 247, 255);

  static const Color primaryText = Color(0xFF000000);
  static const Color allprodect_Listviewbilder_backdraundcolor = Color(0xFFFFFFFF);
  static const Color allprodect_Listviewbilder_bodercolor = Color(0xFFA3A3A3);
  static const Color maincolor = Color(0xFF3c8dbc);
  static Color dBaseColor = const Color(0xFF212121);

  static const Color UsernameColor = Color(0xFF006E83);

  static const Color NewPost = Color(0xFFD9D9D9);
  static const Color ButtoneColor = Color(0xffD9D9D9);

  static const Color NewPostPostBtn = Color(0xFF5C5C5C);

  static const Color appbararrowColor = Color(0xFF0090F9 );

  static const Color HomapadeBackGraundColor = Color(0xFFE7E7E7);

  //Black

  static const Color indicatorgreycolor = Color(0xFF808080);
  static const Color backgroundcolor = Color(0xFFEEEDED);
  static const Color black= Color(0xFF000000);
  static const Color blackShade2 = Color(0xFF2D3041);
  static const Color blackShade3 = Color(0xFF808080);
  ...
  static const Color green2 = Color(0xFF008000);
  ...
  static const Color Light_pink = Color(0xFFfff5f6);
...
//  static const Color violetShade2 = Color(0xFF9121F9);
  ...
  static const Color LightGreen = Color(0xFF63C5DA);
  static const Color DarkBlue = Color(0xFF131a46);
  static const Color LightBlack = Color(0x0);

 static const Color LightBlue = Color(0xFFdeedf0);
 // static const Color LightBlue = Color(0xffa7c4ca);
